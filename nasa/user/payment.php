	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="info">
					<h3 class="text-danger">Please do not go back <span class="glyphicon glyphicon-warning-sign"></span></h3>
				</div>
				</div>
			</div>
		</div>
	...
	<form action="payment.php" method="post" class="form-horizontal">
		<div class="form-group">
			<div class="col-lg-4 col-lg-offset-4">
				<button id="submit" type="submit" name="submit" class="btn btn-lg btn-primary btn-block">Make Payment</button>
			</div>
		</div>
	</form>
...
<?php
	...
	{
		echo "<script>window.open('payget.php?move=next page..!!','_self')</script>";
